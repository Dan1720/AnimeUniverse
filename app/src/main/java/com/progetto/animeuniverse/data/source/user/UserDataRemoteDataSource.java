...
import static com.progetto.animeuniverse.Constants.FIREBASE_USERS_COLLECTION;
...
public class UserDataRemoteDataSource extends BaseUserAuthenticationRemoteDataSource{

    private static final String TAG = UserDataRemoteDataSource.class.getSimpleName();

    private final DatabaseReference databaseReference;

    public UserDataRemoteDataSource(DatabaseReference databaseReference) {
